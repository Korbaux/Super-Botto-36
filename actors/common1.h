...
extern const GeoLayout bubbly_tree_geo_alt[];
extern const GeoLayout spiky_tree_geo_alt[];
extern const GeoLayout snow_tree_geo_alt[];
...
extern const Gfx tree_seg3_dl_bubbly_alt[];
extern const Gfx tree_seg3_dl_bubbly_alt_transparent[];
extern const Gfx tree_seg3_dl_spiky_alt[];
extern const Gfx tree_seg3_dl_spiky_alt_transparent[];
extern const Gfx tree_seg3_dl_snowy_pine_alt[];
extern const Gfx tree_seg3_dl_snowy_pine_alt_transparent[];
