...
static const Vtx explosion_seg3_vertex_030009C8[] = {
    ...
    {{{   128,    384,      0}, 0, {   992,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -128,    384,      0}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
};

// 0x03000A08
ALIGNED8 static const Texture explosion_0[] = {
#include "actors/explosion/explosion_0.rgba16.inc.c"
};

// 0x03001208
ALIGNED8 static const Texture explosion_1[] = {
#include "actors/explosion/explosion_1.rgba16.inc.c"
};

// 0x03001A08
ALIGNED8 static const Texture explosion_2[] = {
#include "actors/explosion/explosion_2.rgba16.inc.c"
};

// 0x03002208
ALIGNED8 static const Texture explosion_3[] = {
#include "actors/explosion/explosion_3.rgba16.inc.c"
};

// 0x03002A08
ALIGNED8 static const Texture explosion_4[] = {
#include "actors/explosion/explosion_4.rgba16.inc.c"
};

// 0x03003208
ALIGNED8 static const Texture explosion_5[] = {
#include "actors/explosion/explosion_5.rgba16.inc.c"
};

// 0x03003A08
ALIGNED8 static const Texture explosion_6[] = {
#include "actors/explosion/explosion_6.rgba16.inc.c"
};

// 0x03003A08
ALIGNED8 static const Texture explosion_7[] = {
#include "actors/explosion/explosion_6.rgba16.inc.c"
};

// 0x03003A08
ALIGNED8 static const Texture explosion_8[] = {
#include "actors/explosion/explosion_8.rgba16.inc.c"
};
...
const Gfx explosion_seg3_dl_0[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, explosion_0),
...
const Gfx explosion_seg3_dl_1[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, explosion_1),
    gsSPBranchList(explosion_seg3_dl_03004208),
};
...
const Gfx explosion_seg3_dl_2[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, explosion_2),
    gsSPBranchList(explosion_seg3_dl_03004208),
};
...
const Gfx explosion_seg3_dl_3[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, explosion_3),
    gsSPBranchList(explosion_seg3_dl_03004208),
};
...
const Gfx explosion_seg3_dl_4[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, explosion_4),
    gsSPBranchList(explosion_seg3_dl_03004208),
};
...
const Gfx explosion_seg3_dl_5[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, explosion_5),
    gsSPBranchList(explosion_seg3_dl_03004208),
};
...
const Gfx explosion_seg3_dl_6[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, explosion_6),
    gsSPBranchList(explosion_seg3_dl_03004208),
};

// 0x03004328 - 0x03004340
const Gfx explosion_seg3_dl_7[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, explosion_7),
    gsSPBranchList(explosion_seg3_dl_03004208),
};

// 0x03004328 - 0x03004340
const Gfx explosion_seg3_dl_8[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, explosion_8),
    gsSPBranchList(explosion_seg3_dl_03004208),
};
